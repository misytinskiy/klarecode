...
export default function ContactModal() {
  const { isOpen, closeModal, initialTab } = useContactModal();
  ...
  // Handle tab initialization when modal opens
  useEffect(() => {
    if (isOpen && !prevIsOpenRef.current) {
      // Modal just opened - set tab based on initialTab
      const tabToSet = initialTab || "message";
              ...
              <div className={styles.modalContent}>
                ...
                <div className={styles.leftSection}>
                  ...
                  <p className={styles.leftSubtitle}>
                    Tell us about your challenge. <br /> We usually respond
                    within 2 hours.
                  </p>
