...
const services = [
  {
    ...
    description: "Custom LLMs, RAG systems & autonomous support agents.",
    expanded: true,
  },
  {
    id: 2,
    ...
    description: "Smart contracts, DeFi protocols & secure dApps architecture.",
    expanded: false,
  },
  {
    id: 3,
    ...
    description: "High-load web platforms & Telegram Mini Apps (TMA).",
    expanded: false,
  },
  {
    id: 4,
    number: "04.",
    title: "DevOps",
    description: "Cloud infrastructure, CI/CD pipelines & 24/7 monitoring.",
    expanded: false,
  },
  {
    id: 5,
    number: "05.",
    title: "SC, NFT, Defi",
    description: "Tokenomics design, NFT marketplaces & auditing.",
    expanded: false,
  },
  {
    id: 6,
    number: "06.",
    title: "Design",
    description: "Product UI/UX, design systems & interactive prototypes.",
    expanded: false,
  },
];
